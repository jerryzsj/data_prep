...
if __name__ == "__main__":
	...
	parser.add_argument('--dataset_type', default='kinect', help='Dataset type [shapes/ycb/mechnet/]')
	parser.add_argument('--dataset_name', default='3cam_30d_600mm_merge', help='Data forder []')
