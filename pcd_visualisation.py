...
if __name__ == "__main__":
	...
	data_name = '3cam_origin_1000_norm'
	data_type = 'mech12'
	dir_1 ='/Users/senjing/3d-vision/data/'+data_type+'/'+data_name+'/test/pcd/'
	...
	save_dir = os.path.dirname(dir_1)
	save_dir = os.path.dirname(save_dir)
	save_dir = os.path.join(save_dir, 'png')
